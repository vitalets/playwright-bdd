 ...
 * The collected locations are always used for technical BDD data and, when `sourceMaps` is
 * enabled, are also combined with Gherkin locations to generate the inline Source Map v3 data.
 */

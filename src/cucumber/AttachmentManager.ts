/**
 * Based on: https://github.com/cucumber/cucumber-js/blob/main/src/runtime/attachment_manager/index.ts
 * Added:
 * As Playwright $testInfo.attach() is always async,
 * we need to track of all calls of AttachmentManager.onAttachment()
 * and wait for all of them at the test end.
 */

/* eslint-disable max-statements, complexity, max-params */

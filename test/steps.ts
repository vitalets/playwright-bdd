...
Then(
  'Passed string arg {string} to equal "foo"',
  async function (this: World, arg: string) {
    expect(arg).toEqual('foo');
  },
);

Then(
  'Passed int arg {int} to equal 42',
  async function (this: World, arg: number) {
...
Then(
  'World prop {string} to be defined',
  async function (this: World, key: keyof World) {
    expect(this[key]).toBeDefined();
  },
);

Then(
  'Doubled {int} to equal {int}',
  async function (this: World, arg: number, doubled: number) {
